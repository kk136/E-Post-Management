            ...
            <div class="row centered-form wrapper">
                <div class="form-register">        
                    <div class="panel-body">
                        <form action="ChangePassword" method="post" role="form" data-toggle="validator">   
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control" name="CPassword" placeholder="Current Password" required autofocus />
                            </div>
                            <div class="form-group">
                                <input name="Npassword" type="password" required class="form-control" id="inputPassword" placeholder="Password" data-minlength="6">
                            ...
                            <button class="btn btn-lg btn-primary btn-block"  name="Submit" value="Login" type="Submit">Change</button>  	
