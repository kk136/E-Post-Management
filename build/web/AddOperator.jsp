...
<div class = "container">
  <div class="wrapper">
    <form action="/Epost_Web/addOperator" method="post" name="Operator_form" class="form-signin">
      <h3 class="form-signin-heading">Add Mobile Operator</h3>
      <hr class="colorgraph">
      <br>
      <input type="text" class="form-control" name="OpName" placeholder="Mobile Operator Name" required="" autofocus />
      <div class="form-group">
        
        <textarea name="OpDesc" rows="5" class="form-control" id="comment" placeholder="Description"></textarea>
      </div>
